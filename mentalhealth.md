...
1. They put the score on a scale between `(-100, 100)`, since the individual components vary between `{1, 2, 3, 4}`. Recording the lowest score on all variables maps to a `mental_health` value of `0`.
